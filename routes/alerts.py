...
def get_alerts():
    ...
    # Automatically hide/expire alerts whose expiry time has passed.
    now = datetime.utcnow()
    expired_alerts = (
        Alert.query
        .filter(
